...
interface EntryWithTags extends Omit<DiaryEntry, 'tags'> {
    tags?: Array<{ name: string; color?: string } | number | string>
}
 ...
 */
export function generateMarkdown(entries: EntryWithTags[] | null | undefined): string {
 ...
 */
export function generatePdfHtml(entries: EntryWithTags[] | null | undefined, opts: PdfOptions = {}): string {
